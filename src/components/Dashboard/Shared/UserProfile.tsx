    ...
    <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-xl max-w-2xl mx-auto text-gray-200">
      ...
      {isEditing ? (
        ...
        <div className="space-y-5">
          ...
          <InfoItem label={ARABIC_STRINGS.phoneNumber} value={user.phoneNumber || ARABIC_STRINGS.notFound} icon="fas fa-phone" />
          <InfoItem label={ARABIC_STRINGS.country} value={DEFAULT_COUNTRY_OPTIONS.find(c => c.value === user.country)?.label || ARABIC_STRINGS.notFound} icon="fas fa-flag" />
...
const InfoItem: React.FC<InfoItemProps> = ({ label, value, icon }) => (
  <div className="flex items-center mb-4">
    ...
    <span className="text-gray-200 mr-2">{value}</span>
  </div>
);
